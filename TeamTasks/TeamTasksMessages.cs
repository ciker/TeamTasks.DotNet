namespace TeamTasks
{
    public static class TeamTasksMessages
    {
        public static readonly string InvalidStartAndDueDates = "invalid-start-and-due-dates";
        public static readonly string ProjectNotFound = "project-not-found";
